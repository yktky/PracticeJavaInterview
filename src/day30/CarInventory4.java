    ...
    public static void main(String[] args) {
        ...
        for (String eachCar : cars) {
            if (eachCar.startsWith("Honda")) {
                //we used split method to seperate  brand and model
        ...
        for (String eachCar : cars) {
            String[] eachCaraSplitted = eachCar.split("-",2);

            //Model is second item in splitted array(at index)
            if (eachCaraSplitted[1].length()==2){
                cntOf2CharModel++;
                System.out.println(eachCar);
                //if you want to only model
                System.out.println(eachCaraSplitted[1]);
            }
        }
        System.out.println("++++++++++++++++++++++++++++++++++++");

        System.out.println("cntOf2CharModel = " + cntOf2CharModel);
