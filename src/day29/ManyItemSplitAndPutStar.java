...
public class ManyItemSplitAndPutStar {
...
//             System.out.println("eachHero = " + eachHero);
            ...
            String hero1 = eachHero;   // payAttention  look heroIdentity class
                                        // instead of One String only we put each String in Array other process is same
